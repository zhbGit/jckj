...
//===================================保存/修改/删除方法=======================================	
	...
	public String save(Permission permission) {
		if (permission.getId() != null && permission.getId().intValue() > 0) {
	...
	@RequestMapping("queryAllPermissionList")
	@ResponseBody
	public Result queryAllPermissionList() {
		List<Permission> permissionList = this.permissionService.queryAllPermissionList();
		return Result.succeed(permissionList);
	}
