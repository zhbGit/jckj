...
import com.wtgkpt.mapper.PermissionMapper;
import com.wtgkpt.service.PermissionService;
...
public class PermissionServiceImpl extends BaseServiceImpl<Permission> implements PermissionService {
	...
	public PageInfo<Permission> getListByPage(int currentNum, int pageSize, String name) {
        ...
        cond.setOrderByClause(" permission_id desc");
	...
	public void savePermission(Permission permission) {
		if (permission != null) {
			...
			try {
				this.permissionMapper.savePermission(permission);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	@Override
	public List<Permission> queryAllPermissionList() {
		List<Permission> list = this.getList();
		return list;
	}
}
